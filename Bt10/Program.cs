...
namespace BaiTap
{
    ...
    public class Bt10
    {
        public static void Main(String[] args)
        {
            ...
            Console.WriteLine("----------------------------------------\n");
            var listResult = students.OrderByDescending(s=>s.Score);
            Console.WriteLine("Danh sach sinh vien duoc sap xep giam dan theo diem la:");
            foreach (var i in listResult)
            {
                Console.WriteLine($"Id: {i.Id}, Name: {i.Name}, Score: {i.Score}");
            }
            Console.ReadKey();
        }
    }
